...
@Test
	...
	long resultado = Calculadora.exponenciacion(Calculadora.suma(5, 2), Calculadora.multiplicacion(1,1));
	long operacion = Calculadora.exponenciacion(Calculadora.suma(5, 2), Calculadora.multiplicacion(1,1));
	assertEquals(operacion, resultado);
